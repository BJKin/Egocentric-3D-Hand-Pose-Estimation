...
# Updated Compatibility patch for chumpy with newer numpy (NumPy 2.0) and TensorBoard.
np.bool = np.bool_
np.int = np.int_
np.float = np.float64
...
# Compatibility patch for chumpy with Python 3.12
import inspect
...
# possible backbones: resnet50, resnet50-arctic, resnet101, mobilenet_v3_l, convnext_l, mobilevit_s, swin_tiny_patch4_window7_224
